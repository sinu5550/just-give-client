...
const loadFirst = () => {
    ...
    if (token) {
        ...
        fetch(`https://justgive-api-sinu5550.onrender.com/user/profile/${user_id}`)
            .then((res) => res.json())
            .then((data) => {
...
const handleListBook = async (event) => {
    ...
    try {
        ...
        const response = await fetch("https://justgive-api-sinu5550.onrender.com/book/list/", {
            method: "POST",
        ...
        const userResponse = await fetch(`https://justgive-api-sinu5550.onrender.com/user/list/${user_id}/`);
        ...
        const coinsResponse = await fetch(`https://justgive-api-sinu5550.onrender.com/user/list/${user_id}/`, {
            method: "PATCH",
            headers: { "Content-Type": "application/json" },
...
const loadTestimonials = () => {
    fetch(`https://justgive-api-sinu5550.onrender.com/user/reviews/`)
        .then((res) => res.json())
...
const displayTestimonials = (reviews) => {
    ...
    reviews.forEach((review) => {
        ...
        fetch(`https://justgive-api-sinu5550.onrender.com/user/profile/${review.reviewer}/`)
            .then((res) => res.json())
            .then((data) => {
